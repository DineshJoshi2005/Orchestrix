            ...
            {open && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed right-0 top-0 z-50 h-screen w-[320px] bg-[#0f1117] border-l border-white/10 shadow-2xl flex flex-col"
                    >
                        ...
                        <div className='p-5'>
                            <div className='rounded-xl bg-white/[0.04] border border-white/10 p-4'>
                                <div className='flex justify-between items-center'>
                                    <div>
                                        <p className='text-slate-400 tetxt-sm'>
                                            Current Plan
                                        </p>
                                ...
                                <div className=' flex-1 overflow-auto space-y-2 p-2'>
                                    <div className='rounded-xl border border-white/10 p-4'>
                                        ...
                                        <button onClick={()=>handleUpgrade("starter")} className='mt-4 w-full rounded-;g bg-indigo-600 hover:bg-indigo-700 py-2 text-white'>Upgrade</button>
                                    </div>
                                    ...
                                    <div className='rounded-xl border border-white/10 p-4'>
                                        ...
                                        <button onClick={() => handleUpgrade("pro")} className='mt-4 w-full rounded-;g bg-indigo-600 hover:bg-indigo-700 py-2 text-white'>Upgrade</button>
                                    </div>
                                </div>
